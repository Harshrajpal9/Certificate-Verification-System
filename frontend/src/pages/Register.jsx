        ...
        <div className="hidden lg:flex flex-col justify-center bg-gradient-to-br from-emerald-600 via-slate-900 to-black text-white p-10 xl:p-14 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="mt-4 text-gray-300 text-sm leading-relaxed max-w-md">
              ...
              and manage certificates with modern authentication
        ...
        <div className="flex items-center justify-center p-6 sm:p-8 md:p-10">
          ...
          <div className="w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                disabled={loading}
                className="w-full bg-gradient-to-r from-emerald-600 to-black hover:from-emerald-700 hover:to-slate-900 text-white py-4 rounded-2xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02] disabled:opacity-70"
              >
